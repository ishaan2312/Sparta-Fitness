...
const GymApp = (() => {
  ...
  function renderRoutines(_params, tab) {
    ...
    return `
      ...
      <div class="gym-content">
        <div class="sortable-list" id="routineList">
          ${routines.map(r => `
  ...
  function renderRoutineEdit({ id }, tab) {
    ...
    return `
      ...
      <div class="gym-content">
        ...
        <div class="sortable-list" id="exerciseList">
    ...
    return `
      ...
      <div class="gym-content pad-bottom">
        <div class="select-list" id="prepareList">
          ${routine.exercises.map(ex => `
            <label class="check-row large checked">
              <input type="checkbox" checked data-prepare value="${esc(ex)}">
