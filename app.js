...
const App = (() => {
  ...
  const renderBuilderScreen = (container) => {
        ...
        <div class="screen-content">
          <div class="builder-form">
            ...
            <div class="exercises-section">
              <h3>Exercises</h3>
              <div class="exercises-list" id="exercisesList" data-sortable-list>
                ${workout.exercises.map((ex, i) => `
                  <div class="exercise-item" data-index="${i}" data-sortable data-id="${i}">
                    <button class="hiit-drag-handle" data-drag-handle aria-label="Drag to reorder">⋮⋮</button>
              ...
              <p class="builder-hint">Hold ⋮⋮ and drag to reorder</p>
    ...
    // Drag to reorder exercises (shares the pointer-based sorter used elsewhere)
    if (typeof GymUI !== 'undefined') {
      GymUI.enableDragSort(document.getElementById('exercisesList'), () => {
        const workout = Storage.getWorkout(currentWorkoutId);
        workout.exercises = Array.from(document.querySelectorAll('.exercise-input'))
  ...
  return {
    ...
    // Sends the timer back to its home screen. Used by the shell when you
    // return to the HIIT tab without a workout in progress.
    goHome: () => {
